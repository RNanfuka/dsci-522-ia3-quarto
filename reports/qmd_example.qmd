...
The Python programming language [@Python] and the following Python packages were used to perform the analysis: pandas [@pandas], altair [@altair], click [Team 2020), as well as Quarto [@Allaire_Quarto_2022]. 
*Note: this report is adapted from [@ttimbers-horses].* 

# Results

![Horse populations for all provinces in Canada from 1906–1972.](../results/horse_pops_plot.png){#fig-horse-pop width=0.8}

From @fig-horse-pop we can see that Ontario, Saskatchewan and Alberta
...
for each province over the time period visualised above to further
...
![Horse populations for the province with the largest standard deviation.](../results/horse_pops_plot_largest_sd.png){#fig-horse-largest width=0.6}
